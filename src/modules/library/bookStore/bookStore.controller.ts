...
import * as bookStoreService from './bookStore.service';
import { catchAsync } from "../../utils/asyncHandler.util";
...
const updateStatus = async (req: Request, res: Response) => {
  try {
    ...
    if (
      !["ACTIVE", "INACTIVE", "OUT_OF_STOCK", "DISCONTINUED"].includes(status)
    ) {
...
// GET LATEST EDITIONS
const getLatestEditions = async (req: Request, res: Response) => {
  try {
